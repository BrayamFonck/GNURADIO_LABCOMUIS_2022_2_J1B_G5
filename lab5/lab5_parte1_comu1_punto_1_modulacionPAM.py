...
# Title: lab5_parte1_comu1_punto_1_modulacionPAM
...
class lab5_parte1_comu1_punto_1_modulacionPAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab5_parte1_comu1_punto_1_modulacionPAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab5_parte1_comu1_punto_1_modulacionPAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab5_parte1_comu1_punto_1_modulacionPAM")
        ...
        # Connections
        ##################################################
        self.connect((self.ModuladorPAM_1, 0), (self.blocks_float_to_complex_0, 0))
        self.connect((self.ModuladorPAM_1, 0), (self.qtgui_freq_sink_x_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0.set_frequency_range(50000000, self.samp_rate)
...
def main(top_block_cls=lab5_parte1_comu1_punto_1_modulacionPAM, options=None):
