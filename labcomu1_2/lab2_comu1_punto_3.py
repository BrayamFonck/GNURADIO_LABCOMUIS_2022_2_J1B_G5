...
class lab2_comu1_punto_3(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lab2_comu1_punto3", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lab2_comu1_punto3")
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab2_comu1_punto_3")
        ...
        self.low_pass_filter_0 = filter.interp_fir_filter_fff(
            ...
            firdes.low_pass(
                ...
                window.WIN_HAMMING,
                6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('/home/labcom/Descargas/Daft Punk  Instant Crush Video ft Julian Casablancas_320kbps.wav', True)
...
def main(top_block_cls=lab2_comu1_punto_3, options=None):
